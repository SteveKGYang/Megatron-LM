...
MODEL_ARGS=(
    ...
    --load /mnt/pvc-blob-nfs/klyang/tuning_result/llama_3B_data_evaluation_Phi_0305/
...
INFERENCE_SPECIFIC_ARGS=(
    ...
    --results-path /mnt/pvc-blob-nfs/klyang/llama_3B_data_evaluation_Phi_0305_90K_few_shot.json
