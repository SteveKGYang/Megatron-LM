...
INFERENCE_SPECIFIC_ARGS=(
    ...
    --results-path /mnt/blob-hptrainingwesteurope-pretraining-out/evaluation_results/data_agent_0604_sft_2D_agent_model_corrected_tp1_core_mmlu_continuation.json
