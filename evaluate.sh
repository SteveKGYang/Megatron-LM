...
MODEL_ARGS=(
    ...
    --load /mnt/blob-hptrainingwesteurope-pretraining/tuning_result/data_agent_0620_rl_nvidia_agent_model_pythia_tp1_core/
...
INFERENCE_SPECIFIC_ARGS=(
    ...
    --results-path /mnt/blob-hptrainingwesteurope-pretraining-out/evaluation_results/data_agent_0620_rl_nvidia_agent_model_pythia_tp1_core_mathqa.json
