...
MODEL_ARGS=(
    ...
    --load /mnt/blob-hptrainingwesteurope-pretraining/tuning_result/pythia_continue_math_only_0621_tp1_core/
...
INFERENCE_SPECIFIC_ARGS=(
    ...
    --results-path /mnt/blob-hptrainingwesteurope-pretraining-out/evaluation_results/pythia_continue_math_only_0621_tp1_core_mathqa.json
