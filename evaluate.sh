...
INFERENCE_SPECIFIC_ARGS=(
    ...
    --results-path /mnt/blob-hptrainingwesteurope-pretraining-out/evaluation_results/llama_3B_nvidia_domain_regmix_evaluation_0401_tp1_core_gsm8k_mmlu_pro_math.json
