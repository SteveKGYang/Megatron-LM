...
MODEL_ARGS=(
    ...
    --load /mnt/blob-hptrainingwesteurope-pretraining/tuning_result/data_agent_0504_sft_smooth_tp1_core/
...
INFERENCE_SPECIFIC_ARGS=(
    ...
    --results-path /mnt/blob-hptrainingwesteurope-pretraining-out/evaluation_results/data_agent_0504_sft_smooth_tp1_core_arc.json
    # --task-list hellaswag,openbookqa,winogrande,arc_easy,arc_challenge,boolq,piqa,sciq,logiqa,lambada
    --task-list arc_easy,arc_challenge
    # --task-list gsm8k
