...
MODEL_ARGS=(
    ...
    --load /mnt/blob-hptrainingwesteurope-pretraining/tuning_result/llama_3B_data_evaluation_dclm_continue_math_only_0227_tp1_core/
...
INFERENCE_SPECIFIC_ARGS=(
    ...
    --results-path /mnt/blob-hptrainingwesteurope-pretraining-out/evaluation_results/llama_3B_data_evaluation_dclm_continue_math_only_0227_tp1_core_mathqa.json
