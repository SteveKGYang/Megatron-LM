...
MODEL_ARGS=(
    ...
    --load /mnt/blob-hptrainingwesteurope-pretraining/tuning_result/llama_3B_data_evaluation_nemotron_m_continue_math_only_0607_tp1_core/
...
INFERENCE_SPECIFIC_ARGS=(
    ...
    --results-path /mnt/blob-hptrainingwesteurope-pretraining-out/evaluation_results/llama_3B_data_evaluation_nemotron_m_continue_math_only_0607_tp1_core_other.json
